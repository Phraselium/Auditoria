...
```bash
dula muestreo poblacion.xlsx importe --metodo mus --materialidad <MP> --semilla 12345
...
```bash
dula analiticos cifras_actual.json cifras_anterior.json --materialidad <MP>
```
...
```bash
dula asientos diario.xlsx 2025-12-31 --materialidad <MP> --perfil ESTANDAR
```
