...
```bash
dula amortizaciones <inventario> <inicio> <fin>   # área A
dula leasing <contratos> <fecha-cierre>           # área F
dula financiacion <cartera> <fecha-cierre>        # áreas D y E
dula reservas <sumas-y-saldos>                    # área G
dula muestreo <población> <columna> --metodo mus  # cualquier área
```
