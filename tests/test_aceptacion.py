...
from audita import (amortizaciones, analiticos, asientos, calidad, comparador,  # noqa: E402
                  cuadres, financiacion, ingesta, leasing, materialidad,
                  muestreo, perfil)
from audita.encargo import Encargo  # noqa: E402
from audita.excel_out import PapelDeTrabajo  # noqa: E402
from audita.traza import RegistroTrazas, Traza, huella  # noqa: E402
...
def criterio_3_comparador(ctx: dict) -> None:
    ...
    res_inf = comparador.informe_vs_ccaa_definitivas(
        {"denominacion_social": "TRANSPORTES SINTETICOS SL", "nif": cif_sintetico(),
...
def criterio_6_informe() -> None:
    ...
    ruta = os.path.join(RAIZ, "plantillas", "informe-auditoria.md")
