# area-proveedores-y-compras

> Área H — Conciliaciones, corte y búsqueda de pasivos no registrados.

> **Cuándo:** Úsala siempre que haya compras o gastos de explotación significativos. Términos: audita, proveedores, compras, conciliaciones, saldos, búsqueda, pasivos, registrados, operaciones, confirmaciones, procedimiento, central, ningún, perfil.
...
`referencias/programas/proveedores-y-compras.md`. Se carga bajo demanda: no lo copies aquí.

## Ejecución

```bash
audita muestreo 00-fuentes/pagos_posteriores.xlsx importe \
