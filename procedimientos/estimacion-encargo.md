...
| `referencias/tarifas.json` | No | Sin él, los honorarios salen `[PENDIENTE-CLIENTE]` |
...
```bash
audita ingesta <sumas_y_saldos.xlsx> --diario <diario.xlsx> --ejercicio <AAAA>
```
...
```bash
audita estimar drivers.json --tarifas referencias/tarifas.json \
