...
> Selecciona la muestra (MUS, atributos o dirigido) y proyecta los errores a la población.

> **Cuándo:** Úsala cuando haya que seleccionar partidas para probar o evaluar los errores de una muestra ya examinada. Términos: ejecuta, selección, muestras, método, elegido, diseño, pruebas, unidades, monetarias, atributos, controles, dirigido, estadístico, documentando.

> **Necesita:** `[población.xlsx] [columna-importe]`
