...
mejor funcionan en la cartera del despacho:
...
`referencias/programas/clientes-e-ingresos.md`. Se carga bajo demanda: no lo copies aquí.

## Ejecución

```bash
audita muestreo 00-fuentes/mayor_clientes.xlsx debe --metodo mus \
