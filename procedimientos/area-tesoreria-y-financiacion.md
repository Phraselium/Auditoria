# area-tesoreria-y-financiacion

> Áreas D y E — Conciliaciones bancarias, confirmaciones, deuda viva y covenants.

> **Cuándo:** Escala desde tres créditos hasta carteras de pólizas, confirming y factoring. Términos: audita, tesorería, financiación, conciliaciones, bancarias, gestión, seguimiento, confirmaciones, avales, garantías, pignoraciones, saldos, indirectos, normalización.

> **Necesita:** `[cartera.xlsx] [fecha-cierre]`
...
`referencias/programas/tesoreria-y-financiacion.md`. Se carga bajo demanda: no lo copies aquí.

## Ejecución

```bash
audita financiacion 00-fuentes/cartera.xlsx 2025-12-31 \
