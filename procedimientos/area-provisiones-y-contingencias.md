# area-provisiones-y-contingencias

> Área K — Circulariza abogados y evalúa litigios, provisiones y pasivos contingentes.

> **Cuándo:** Úsala cuando haya litigios, reclamaciones, saldos en el grupo 14 o 499, o cuando la circularización bancaria revele avales. Términos: audita, provisiones, pasivos, contingentes, circularización, abogados, evaluación, litigios, verificación, cálculo, desglose.
...
`referencias/programas/provisiones-y-contingencias.md`. Se carga bajo demanda: no lo copies aquí.

## Ejecución

```bash
audita muestreo 00-fuentes/mayor_623.xlsx importe --metodo dirigido \
