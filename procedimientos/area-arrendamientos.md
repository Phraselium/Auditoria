...
> Área F — Recalcula y clasifica cientos de contratos de leasing y saca el cuadro de vencimientos.
...
> **Necesita:** `[ficheros-de-contratos] [fecha-cierre]`
...
```python
import pandas as pd
from audita import ingesta, leasing
...
```bash
audita leasing 00-fuentes/contratos_consolidados.xlsx 2025-12-31 \
