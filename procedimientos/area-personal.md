...
> Área I — Concilia nóminas, seguros sociales y contabilidad; indemnizaciones y retenciones.

> **Cuándo:** Úsala cuando haya gastos de personal significativos, que es prácticamente siempre. Términos: audita, personal, conciliación, nóminas, seguros, sociales, contabilidad, indemnizaciones, provisiones, obligaciones, retenciones.
...
`referencias/programas/personal.md`. Se carga bajo demanda: no lo copies aquí.

## Ejecución

```bash
audita analiticos 00-fuentes/personal_actual.json \
