...
> Riesgos por área y afirmación, situados en el espectro de riesgo inherente y motivados.

> **Cuándo:** Úsala en planificación, tras el entendimiento de la entidad, o cuando aparezca un hallazgo que obligue a reevaluar el riesgo. Términos: identifica, valora, riesgos, incorrección, material, afirmación, situando, espectro, riesgo, inherente, motivando, valoración, factores, concurrentes.
...
## 3. Riesgos típicos de la cartera del despacho

Punto de partida, no lista cerrada. El catálogo completo por área está en
`referencias/catalogo-riesgos.md`.
