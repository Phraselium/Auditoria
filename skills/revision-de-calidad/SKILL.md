...
```bash
cat ${CLAUDE_PLUGIN_ROOT}/procedimientos/estado-del-encargo.md
```
...
audita pbc <encargo> --recibido P001
...
```bash
audita calidad <carpeta-encargo> --pre-vuelo     # durante la campaña
audita calidad <carpeta-encargo> \
...
```bash
audita validar <encargo> --listar                     # ver el registro
