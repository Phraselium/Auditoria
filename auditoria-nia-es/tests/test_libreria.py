...
def t_paquete_claude_ai() -> None:
    ...
    zcc = os.path.join(RAIZ, "build", "auditoria-nia-es-claude-code.zip")
    ...
    with zipfile.ZipFile(zcc) as z:
        ...
        for req in ("auditoria-nia-es/.claude-plugin/plugin.json",
                    ...
                    "auditoria-nia-es/shared/scripts/audita/cli.py",
                    "auditoria-nia-es/shared/procedimientos/materialidad.md",
                    "auditoria-nia-es/shared/references/mapeo-pgc.json",
                    "auditoria-nia-es/shared/templates/informe-auditoria.md"):
