...
primero `AUDITA_RAIZ` (que exporta el lanzador), y si no, deduciendola desde la
...
def raices_candidatas() -> list[str]:
    ...
    # .../<raiz>/shared/scripts/audita/rutas.py  -> cuatro niveles
    # .../<raiz>/scripts/audita/rutas.py         -> tres niveles
