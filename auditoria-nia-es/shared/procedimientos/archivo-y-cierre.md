...
> Ensambla el archivo final: índice, referencias cruzadas, conservación y registro de uso de IA.

> **Cuándo:** Úsala tras la firma del informe, para cerrar el archivo, o cuando haya que localizar documentación de un encargo anterior. Términos: ensambla, archivo, encargo, dentro, normativo, índice, completo, papeles, referencias, cruzadas, control, versiones, registro, conservarse.
...
```bash
audita validar <encargo> --listar    # ninguna debe quedar sin validar
```
