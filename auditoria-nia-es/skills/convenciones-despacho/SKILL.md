...
Cuatro hojas, siempre, generadas por `shared/scripts/audita/excel_out.py`:
...
### 4.1 Materialidad — `shared/scripts/audita/materialidad.py`
...
### 4.3 Muestreo — `shared/scripts/audita/muestreo.py`
...
### 4.4 Analíticos — `shared/scripts/audita/analiticos.py`
...
### 4.5 Festivos para el test de asientos — `shared/scripts/audita/asientos.py`
