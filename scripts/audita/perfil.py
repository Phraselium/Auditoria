...
Las tarifas por categoria se configuran en skills/convenciones-despacho/SKILL.md. Sin tarifas propias, el
...
# se ajustan con datos historicos propios (ver skills/convenciones-despacho/SKILL.md, seccion Calibracion).
HORAS_BASE = {
    ...
    if tarifas:
        ...
        if faltan:
            ...
            resultado["nota_honorarios"] = (
                ...
                "tarifa; configurelas en skills/convenciones-despacho/SKILL.md.")
        else:
        ...
        resultado["nota_honorarios"] = ("No se han configurado tarifas por categoria. "
                                        "Vease skills/convenciones-despacho/SKILL.md, seccion Tarifas.")
    return resultado
